...
| app,<br>app_name                                                   | app                         |
| num_attachments,<br>attachment_count                               | attachment_count            |
...
| target_user_email,<br>recipient,<br>to_address                     | dest_email_address          |
| tgt_user,<br>target_user                                           | dest_user                   |
| device_name,<br>device                                             | device_name                 |
| external_domain_sender,<br>email_domain                            | email_domain                |
| sub_event_type,<br>event_subtype                                   | event_subtype               |
| failure_code,<br>failure_reason,<br>reason                         | failure_code                |
...
| result,<br>outcome,<br>url_verdict                                 | result                      |
