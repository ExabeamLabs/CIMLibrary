...
### New-Scale Activity Type: http-request:success
...
| risk_level,<br>alert_severity                                      | alert_severity              |
| app_class,<br>app_group                                            | app_group                   |
...
| failure_reason,<br>reason                                          | failure_reason              |
...
| response_code,<br>result_code                                      | http_response_code          |
| ransomware_name,<br>malware_name                                   | malware_name                |
